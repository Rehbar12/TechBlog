  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        ...
        <div class="dropdown-menu sec-background " aria-labelledby="navbarDropdown">
          <!-- <a class="dropdown-item" href="#"></a> -->
          <a class="dropdown-item font-italic " href="#">All About Computer Latest Technologies</a>
          
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="https://www.linkedin.com/in/mohd-rehbar-bb725b200/"> <span class="fa fa-linkedin-square"></span>Developer</a>
      </li>
       <li class="nav-item">
        <a class="nav-link" href="Login_page.jsp"> <span class="fa fa-user-circle-o"></span>Login</a>
      </li>
       <li class="nav-item">
        <a class="nav-link" href="register_page.jsp"> <span class="fa fa-plus"></span>Register</a>
      </li>
